        ...
        <div>
            <form onSubmit={handleSubmit()} >
                <div>
                    ...
                    <div>
                        <input type='file' onChange={e=>setImageFile(e.target.files[0])} placeholder='Insérer une image' required />
                    </div>
                </div>
                <button className="articleForm-button" >Ajouter un article</button>
            </form>
        </div>
    )
}
